...
fn main() {
    ...
    const SAMPLES_PER_PIXEL: u16 = 25;
    ...
    let mut cube = load_mesh("models/plane.obj", false);
    //cube.rotate(Vec3::new(25.0, -60.0, 0.0));
    cube.rotate(Vec3::new(90.0, 45.0, 0.0));
    cube.translate(Vec3::new(0.0, -0.5, -2.5));
    //cube.translate(Vec3::new(0.0, -0.5, -4.0));
    //cube.material = MaterialEnum::Diffuse(Diffuse::new(Color::new(0.7, 0.3, 0.3)));
    cube.material = MaterialEnum::Metal(Metal::new(Color::new(0.8, 0.6, 0.2), 0.3));
    ...
    plane2.scale(1.0);
    plane2.rotate(Vec3::new(90.0, -45.0, 0.0));
    plane2.translate(Vec3::new(0.0, -0.5, -3.0));
    plane2.material = MaterialEnum::Metal(Metal::new(Color::new(0.8, 0.6, 0.2), 0.0));
    //plane2.material = MaterialEnum::Diffuse(Diffuse::new(Color::new(0.7, 0.3, 0.3)));*/
